...
namespace InternetShop
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            shop.CreateNewShopItem("NVIDIA GTX 1060 6GB", 15600,"The PNY GeForce GTX 1060 graphics card is loaded with innovative new gaming technologies, making it the perfect choice for the latest high-definition games. Powered by NVIDIA Pascal™ – the most advanced GPU architecture ever created – the GeForce GTX 1060 delivers brilliant performance that opens the door to virtual reality and beyond.");
            ...
            Admin kirgo = shop.SignUpAdmin("Kirgo", "kirgotop", "kirgotop");
            shop.SignUp("Solify", "1234", "1234");
            shop.PrintProductList();
            kirgo.SearchShopItem("NVIDIA GTX 1060 6GB");
            kirgo.AddShopItemToBasket("NVIDIA GTX 1060 6GB");
            kirgo.AddShopItemToBasket("NVIDIA GTX 1060 6GB");
            kirgo.AddShopItemToBasket("MSI GeForce RTX 2060 12GB");
            kirgo.BuyItemsFromBasket();
            kirgo.AddShopItemToBasket("MSI GeForce RTX 2060 12GB");
            kirgo.AddShopItemToBasket("NVIDIA RTX 4090 24GB");
            kirgo.BuyItemsFromBasket();
        }
    }
}